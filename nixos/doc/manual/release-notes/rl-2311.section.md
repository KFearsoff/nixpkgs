...
- A new option was added to the Nginx module that allows adding dynamically linked Nginx modules. This allows enabling some modules that weren't working before, such as `nginxModules.opentracing`, which only supports dynamic linking.
